<div class="modal-container">
   ...
   <h4>Pengaturan Promo</h4>
      <div class="form-group">
          ...
          <div>
              <div class="btn-group">
                  <button type="button" :class="{'btn':true,'btn-primary':totalBeli}" @click="totalBeli=true">Total</button>
                  <button type="button" :class="{'btn':true,'btn-primary':!totalBeli}" @click="totalBeli=false">Item</button>
              </div>
          </div>
      </div>
